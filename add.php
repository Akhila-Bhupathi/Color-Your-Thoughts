...
<html lang="en">
  ...
  <body>
  <a href="uhome.php" style="text-decoration: none; color: white"><button
    ...
    if(isset($_POST["submit"])){
      ...
      if(in_array($filetype,$allowtypes))
      {
          ...
          $query="insert into user_posts(user_id,title,description,painting,likes) values('$user_id','$title','$description','$imgcontent',0)";
          if(mysqli_query($con,$query)){
              echo "<script>alert('Successfiul');</script>";
          }
      }
      else{
